...
::: justified
A lo largo de mi formación y mi carrera profesional desarrollé múltiples capacidades relacionadas al manejo de diversas **metodologías**, **herramientas**, y competencias blandas o ***soft skills***. Hago aquí una breve enumeración de las habilidades más relevantes que he puesto en práctica en los últimos tiempos y podrían ser de utilidad para organizaciones de distintos ámbitos.
:::
...
**PhD Thesis Exploring Knowledge Dynamics in Academia-Industry Collaborations within a Local Ecosystem**<br>

::: justified
Examined knowledge production within academia-industry collaborations (AICs) in San Carlos de Bariloche, Argentina, using Boisot's I-Space framework to characterize knowledge co-creation, and individual and organizational learning dynamics. Employing a mixed-methods approach, I integrated survey data with insights gathered from in-depth interviews to explore diverse modes of collaboration and their associated knowledge properties and learning processes. The findings from this study provided strategic recommendations for stakeholders to enhance reciprocal learning and knowledge co-creation within AICs. Furthermore, by laying the groundwork for cross-institutional knowledge partnerships, this project contributes to shaping future strategies and policies in inter-institutional collaborations.
:::

**Network Analysis of Academic Collaborations** <br>

::: justified
Investigated collaborations between academic and business organizations, utilizing social network analysis to visualize and analyze evolving networks of scholarly collaboration.
:::

**Consumer Price Index (CPI) Development** <br>

::: justified
Participated with CEPAL in the development of a regional CPI, a crucial economic indicator for monitoring inflation and guiding policy decisions in Argentina.
:::
